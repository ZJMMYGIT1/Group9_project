...
<body>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="index.html">首页</a> > <a href="computerList.jsp">电脑、办公</a></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="list_top">
				...
				<div class="hotsale fl">
					...
					<ul>
						...
						<li>
							<dl>
								<dt><a href="goods.html"><img src="images/list_hot3.jpg" alt="" /></a></dt>
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="goods.jsp"><img src="images/goods5.jpg" alt="" /></a></dt>
							<dd><a href="goods.jsp">ThinkPad E42014英寸笔记本电脑（i5-2450M 2G 320G 蓝牙 摄像头）</a></dd>
